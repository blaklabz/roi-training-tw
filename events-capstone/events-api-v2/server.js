...
const mockEvents = {
  events: [
    {
      id: 1,
      title: "Company Pet Show",
      event_time: "November 6 at Noon",
      description: "Super-fun with furry friends!",
      location: "Reston Dog Park",
      likes: 0,
      datetime_added: "2021-09-30:12:00",
    },
    {
      id: 2,
      title: "Company Picnic",
      event_time: "July 4th at 10:00AM",
      description: "Come for free food and drinks.",
      location: "Central Park",
      likes: 0,
      datetime_added: "2021-09-30:12:02",
    },
  ],
};
...
app.get("/events", (req, res) => {
  const sql =
    "SELECT id, title, event_time, description, location, likes, datetime_added FROM events;";
...
app.post("/events", (req, res) => {
  ...
  const sql =
    "INSERT INTO events (title, event_time, description, location) VALUES (?,?,?,?);";
